...
public class CircleIndexIndicator implements IIndicator {
    Indexface indexfaceListener;
    public CircleIndexIndicator(){ }
    public CircleIndexIndicator(Indexface indexfaceListener){
    ...
    public void onShow(ViewPager viewPager) {
        ...
        circleIndicator.setViewPager(viewPager,indexfaceListener);
    }
