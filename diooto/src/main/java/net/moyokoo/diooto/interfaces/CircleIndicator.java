...
public class CircleIndicator extends LinearLayout {
    ...
    private Indexface indexfaceListener;
    private final ViewPager.OnPageChangeListener mInternalPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            if (indexfaceListener != null) {
                indexfaceListener.getIndxt(position);
            }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mIndicatorBackground.setColor(getResources().getColor(R.color.white));
    ...
    public void setViewPager(ViewPager viewPager, Indexface indexfaceListener) {
        this.indexfaceListener = indexfaceListener;
